...
namespace ClientWebApplication1.CurrencyReference {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CurrencyReference.ConverterSoap")]
    public interface ConverterSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ClientWebApplication1.CurrencyReference.ConvertDataTableColumnResponse ConvertDataTableColumn(ClientWebApplication1.CurrencyReference.ConvertDataTableColumnRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ConvertDataTableColumn", ReplyAction="*")]
        System.Threading.Tasks.Task<ClientWebApplication1.CurrencyReference.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(ClientWebApplication1.CurrencyReference.ConvertDataTableColumnRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ConverterSoapChannel : ClientWebApplication1.CurrencyReference.ConverterSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConverterSoapClient : System.ServiceModel.ClientBase<ClientWebApplication1.CurrencyReference.ConverterSoap>, ClientWebApplication1.CurrencyReference.ConverterSoap {
        ...
        ClientWebApplication1.CurrencyReference.ConvertDataTableColumnResponse ClientWebApplication1.CurrencyReference.ConverterSoap.ConvertDataTableColumn(ClientWebApplication1.CurrencyReference.ConvertDataTableColumnRequest request) {
        ...
        public void ConvertDataTableColumn(ref System.Data.DataSet ds, int TableIndex, string ColumnName, string FromCurrency, string ToCurrency) {
            ClientWebApplication1.CurrencyReference.ConvertDataTableColumnRequest inValue = new ClientWebApplication1.CurrencyReference.ConvertDataTableColumnRequest();
            inValue.ds = ds;
            inValue.TableIndex = TableIndex;
            inValue.ColumnName = ColumnName;
            inValue.FromCurrency = FromCurrency;
            inValue.ToCurrency = ToCurrency;
            ClientWebApplication1.CurrencyReference.ConvertDataTableColumnResponse retVal = ((ClientWebApplication1.CurrencyReference.ConverterSoap)(this)).ConvertDataTableColumn(inValue);
            ds = retVal.ds;
        }
        
        public System.Threading.Tasks.Task<ClientWebApplication1.CurrencyReference.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(ClientWebApplication1.CurrencyReference.ConvertDataTableColumnRequest request) {
